        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumMarks = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    AllowSubmissionUpdates = table.Column<bool>(type: "boolean", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_AspNetUsers_TeacherUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_TeacherUserId_UpdatedAt",
                table: "Assignments",
                columns: new[] { "TeacherUserId", "UpdatedAt" });
        }
